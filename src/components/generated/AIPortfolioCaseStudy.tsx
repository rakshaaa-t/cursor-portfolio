...
export const AIPortfolioCaseStudy: React.FC = () => {
  ...
  const tabs = ["Overview", "Strategy", "Sitemaps", "Moodboards", "Design", "Product", "Final Thoughts"];
      ...
      <div className="relative w-full px-4 md:px-6 lg:px-20 pt-24 md:pt-28 lg:pt-[120px] pb-20 flex flex-col items-center">
        ...
        >
          <div className="relative w-full aspect-[16/9] flex items-center justify-center py-8">
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-4 md:gap-8 overflow-x-auto max-w-full px-4">
              {tabs.map((tab) => (
                <button
                  key={tab}
                  onClick={() => setActiveTab(tab)}
                  className={`text-xs md:text-sm font-medium transition-all pb-1 whitespace-nowrap ${
                    activeTab === tab
